...
const Reports = () => {
  return (
    <Router>
      <Switch>
        <Route
          path="/reports/view_seller_history"
          component={ViewSellerHistory}
        />
        <Route
          path="/reports/avg_time_in_inventory"
          component={AverageTimeInInventory}
        />
        <Route
          path="/reports/price_per_condition"
          component={PricePerCondition}
        />
        <Route path="/reports/part_statistics" component={PartStatistics} />
        <Route
          path="/reports/monthly_sales/origin"
