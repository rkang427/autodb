const seedDatabase = async () => {
    ...
    try {
        ...
        await client.query("INSERT INTO customer (tax_id) VALUES ('123456789'), ('987654321');");

        // Insert corresponding individual and business records
        await client.query("INSERT INTO individual (ssn, first_name, last_name) VALUES ('123456789', 'John', 'Doe');");
        await client.query("INSERT INTO business (tin, business_name) VALUES ('987654321', 'Doe Enterprises');");
